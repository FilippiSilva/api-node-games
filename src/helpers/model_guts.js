...
module.exports = ({
  ...
  const findAll = filters => knex.select(selectableProps)
    .from(tableName)
    .orderBy(filters.query.order || 'id', filters.query.orderType || 'asc')
    .timeout(timeout)
    .paginate(filters.query.limit, filters.query.page, true)
